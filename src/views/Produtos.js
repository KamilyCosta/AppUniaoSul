...
const MyComponennt = props => (
    ...
    <ScrollView>
        ...
        <Card style={{ marginTop: 15 }}>
            <Card.Content>
                <Text style={{fontWeight:'bold', fontSize: 25, color: "#00003d"}}>Desinfetantes</Text>
                <Card.Cover source={{ uri: 'https://attachments.office.net/owa/kamily.costa%40portalsesisp.org.br/service.svc/s/GetAttachmentThumbnail?id=AAMkAGZkYWFkZjEwLTE3NTgtNDkwNC1hNTNiLWRiYzQyYzA4MmE1YQBGAAAAAADYcovAusobTqlMsgmz7xf9BwBwcC6Dr2SDQbD2yTXEpg%2BdAAAAAAEMAABwcC6Dr2SDQbD2yTXEpg%2BdAAXUUZLYAAABEgAQANFEm1iuP05Cv9ggcTvT01k%3D&thumbnailType=2&token=eyJhbGciOiJSUzI1NiIsImtpZCI6IkU1RDJGMEY4REE5M0I2NzA5QzQzQTlFOEE2MTQzQzAzRDYyRjlBODAiLCJ0eXAiOiJKV1QiLCJ4NXQiOiI1ZEx3LU5xVHRuQ2NRNm5vcGhROEE5WXZtb0EifQ..kjH3QMRCuZu5NGbgZXlbu64l5xo_oh_2YiHLyM1mlyRNO4HwMUEF2arijnoU9A5NHZku0KxRei0tx-zaR-xr2qoMXnG3g2wmEqEhHij912XTA8Qbsp5KRzhWleieZyWNrsPvzlFYBy6Xw8BDodHRWFoYNbef9gb19jU9lt5NGBop2jJ6a4fjPMPwLvbnVn0mt4iogw_GXwpv8wb-yxJBqwgpta3Vp-h-Dha-UsgCKzSKsuqQTOsXJPk2JOYxkMnPThcKFjrZCIHdd0VEw7IJbjD96F7rjyNjXbUKW6pYgAPZ4xEXJj3Y50kJd_zI35ruxmnEXowqVjYZUO_EMN5KEw&X-OWA-CANARY=bdvoV5Aj--gAAAAAAAAAAJDDIGxAkdwY96g3DdqVVvSDPOvfzacXFhrdKkYvfPbdSjlkqpFLwhg.&owa=outlook.office365.com&scriptVer=20240607002.20&clientId=80B41ECF7F304B4283AE8BC02977A233&animation=true' }}
                />
                <Text variant="bodyMedium" >Produtos de Limpeza - Kit com 10 desinfetantes 1L</Text>
                <Text variant="bodyMedium">Para promover saúde e bem-estar, especialmente  doados para quem mais precisa!</Text>
                <Text variant="bodyMedium" style={{ color: 'green', marginTop: 30 }}>10% de desconto</Text>
                <Text style={{ fontWeight: 'bold', fontSize: 20}}>R$ 72,00</Text>
                <Button style={{marginTop: 10,  backgroundColor:'#448cf2'}}
                mode="contained"
                onPress={() => props.navigation.navigate('Carrinho')}>
                Adicionar ao carrinho
                </Button>
